...
//const component = loader('components/user');
//const type = loader('filter', 'routes.js');
//const componentX = loader('components/comp');


const user = require('../../index.js')('components/user');
const userMiddleware = user.middleware();
console.log(userMiddleware.run());
